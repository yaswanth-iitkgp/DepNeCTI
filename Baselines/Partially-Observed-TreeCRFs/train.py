...
parser.add_argument("--lambda_ent", default=1e-2, type=float,
                    help="lambda_ent")
parser.add_argument("--dataset", default="GENIA", type=str,
                    help="ACE04,ACE05,GENIA,NNE")
parser.add_argument("--latent_size", default=86, type=int,
                    help="latent_size")
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        with torch.no_grad():
            ...
            with open("predictions.txt", "a") as f:
                f.write("epoch : " + str(_) + "\n")
                f.write("input_ids to tensor: " + np.array2string(inputs["input_ids"][0].detach().cpu().numpy()) + "\n")
