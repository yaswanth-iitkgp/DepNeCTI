...
class Processor(DataProcessor):
    ...
    def __init__(self, logger, dataset, latent_size):
        ...
        if dataset == "ACE04" or dataset == "ACE05":
            ...
            #fine grain nested sacti
            self.labels = ['A', 'A1', 'A2', 'A3','A4','A5','A6' ,'A7','B', 'BS3', 'BS5', 'BS6', 'BS7', 'BV', 'BVS', 
  'Bb', 'Bmsn', 'Bs', 'Bs2', 'Bs3', 'Bs4', 'Bs5', 'Bs6', 'Bs7', 'BsS', 'BsU', 'Bsm7', 'Bsmn',
  'Bsn', 'Bsp', 'Bss', 'Bsu', 'Bv', 'Bv3', 'BvP', 'BvS', 'BvU', 'Bvp', 'Bvs', 'Bvtu', 'D', 
  'D1', 'Di', 'Ds', 'E', 'di', 'ds','d', 'K', 'K1', 'K2', 'K3', 'K4', 'K5', 'K6', 'K7',
  'Km', 'T', 'T1', 'T2', 'T3', 'T4', 'T5','T6', 'T7', 'TM', 'Tds', 'Tdt', 'Tdu', 'Tg',
  'Tk', 'Tm', 'Tm7', 'Tn', 'Tp', 'U', 'k', 'k1', 'k2', 'k6', 'k7', 't6', 'u', 'S', 's','0']
            #self.labels = ['Bahuvrihi','Dvandva', 'Tatpurusha', 'Avyayibhava', 'Other']
        else:
            raise NotImplementedError()
...
def eval(args, outputs, partial_masks, label_size, gather_masks):
    ...
    for output, partial_mask, l in zip(outputs, partial_masks, gather_masks):
        ...
        with open("predictions.txt", "a") as f:
            f.write("preds = " + str(preds) + "\n")
            f.write("gold = " + str(golds) + "\n"+"\n")
