...
model_path = 'save_models/best_SequenceGeneratorModel_f_2023-05-15-12-19-34-314652'
bart_name = 'facebook/bart-large'
target_type = 'span'
device = 'cuda:0'

#cache_fn = f"caches/fine_grained_data_{bart_name}_{dataset_name}_{target_type}.pt"
cache_fn = "caches/data_facebook/bart-large_genia_span.pt"
...
with open('./mapping2id.txt','w') as f:
    f.write(json.dumps(mapping2id))
